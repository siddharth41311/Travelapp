...
SELECT * FROM HotelBookingss

ALTER TABLE HotelBookingss DROP COLUMN Amenities;

CREATE TABLE Final_Hotel_Booking (
    travelCode VARCHAR(20) PRIMARY KEY,
    User_ID INT NOT NULL,
    Departure VARCHAR(50) NOT NULL,
    Arrival VARCHAR(50) NOT NULL,
...
ALTER TABLE HotelBooking DROP COLUMN Total_Price_per_Night,Room_Price_per_Night;